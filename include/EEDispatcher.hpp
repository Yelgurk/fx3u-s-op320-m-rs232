...
public:
    ...
    EEUnit ee_blowgun_preset_1 = EEUnit(0x0000, &ee24c64, false),
           ...
           //ee_safe_is_pasteur_runned = EEUnit(0x002D, &ee24c64, false),
           //ee_safe_is_pasteur_finished = EEUnit(0x002E, &ee24c64, false),
           ///!!! ee_safe_pasteur_estimated_mm = EEUnit(0x002F, &ee24c64, false), 
           //ee_safe_is_heating_finished = EEUnit(0x0030, &ee24c64, false),
           //ee_safe_is_freezing_finished = EEUnit(0x0031, &ee24c64, false),

           ee_proc_pasteur_running = EEUnit(0x0032, &ee24c64, false),
           ee_proc_pasteur_paused = EEUnit(0x0033, &ee24c64, false),
           ee_proc_pasteur_part_finished = EEUnit(0x0034, &ee24c64, false),
           ee_proc_need_in_freezing = EEUnit(0x0035, &ee24c64, false),
           ee_proc_need_in_heating = EEUnit(0x0036, &ee24c64, false),
           ee_proc_freezing_part_finished = EEUnit(0x0037, &ee24c64, false),
           ee_proc_heating_part_finished = EEUnit(0x0038, &ee24c64, false),
           ee_proc_waterJacket_filled_yet = EEUnit(0x0039, &ee24c64, false),
           ee_proc_time_span = EEUnit(0x003A, &ee24c64, false),
           ee_proc_pasteur_tempC = EEUnit(0x003B, &ee24c64, false),
           ee_proc_freezing_tempC = EEUnit(0x003C, &ee24c64, false),
           ee_proc_heating_tempC = EEUnit(0x003D, &ee24c64, false),
           ee_proc_preset_runned_index = EEUnit(0x003E, &ee24c64, false),
           ee_proc_started_hh = EEUnit(0x003E, &ee24c64, false),
           ee_proc_started_mm = EEUnit(0x003E, &ee24c64, false),
           ee_proc_estimated_mm = EEUnit(0x003E, &ee24c64, false),

           ee_dynamic_proc_last_point_hh = EEUnit(0x003E, &ee24c64, false),
           ee_dynamic_proc_last_point_mm = EEUnit(0x003E, &ee24c64, false),

           ee_dynamic_rtc_curr_hh = EEUnit(0x0043, &ee24c64, false, ee24c64.getSectorStartAddr()),
           ee_dynamic_rtc_curr_mm = EEUnit(0x0044, &ee24c64, false, ee24c64.getSectorStartAddr()),
           ee_dynamic_rtc_curr_ss = EEUnit(0x0045, &ee24c64, true, ee24c64.getSectorStartAddr());
