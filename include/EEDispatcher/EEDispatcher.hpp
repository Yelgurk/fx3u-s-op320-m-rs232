...
public:
    ...
    EEUnit ee_blowgun_preset_1 = EEUnit(0x0000, &ee24c64, false),
           ...
           ee_proc_started_hh = EEUnit(0x0035, &ee24c64, false),
           ee_proc_started_mm = EEUnit(0x0036, &ee24c64, false),
           ee_proc_started_DD = EEUnit(0x0037, &ee24c64, false),
           ee_proc_started_MM = EEUnit(0x0038, &ee24c64, false),
           ee_proc_started_YY = EEUnit(0x0039, &ee24c64, false),
           ee_proc_paused_hh = EEUnit(0x003A, &ee24c64, false),
           ee_proc_paused_mm = EEUnit(0x003B, &ee24c64, false),
           ee_proc_paused_DD = EEUnit(0x003C, &ee24c64, false),
           ee_proc_paused_MM = EEUnit(0x003D, &ee24c64, false),
           ee_proc_paused_YY = EEUnit(0x003E, &ee24c64, false),
           ee_proc_exp_finish_hh = EEUnit(0x003F, &ee24c64, false),
           ee_proc_exp_finish_mm = EEUnit(0x0040, &ee24c64, false),
           ee_proc_exp_finish_DD = EEUnit(0x0041, &ee24c64, false),
           ee_proc_exp_finish_MM = EEUnit(0x0042, &ee24c64, false),
           ee_proc_exp_finish_YY = EEUnit(0x0043, &ee24c64, false),
           ee_proc_finished_hh = EEUnit(0x0044, &ee24c64, false),
           ee_proc_finished_mm = EEUnit(0x0045, &ee24c64, false),
           ee_proc_finished_DD = EEUnit(0x0046, &ee24c64, false),
