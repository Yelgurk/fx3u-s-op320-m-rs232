...
public:
    ...
    EEUnit ee_blowgun_preset_1 = EEUnit(0x0000, &ee24c64, false),
           ...
           ee_proc_pasteur_state = EEUnit(0x002E, &ee24c64, false),
           ee_proc_pasteur_preset = EEUnit(0x002F, &ee24c64, false),
           ee_proc_need_in_freezing = EEUnit(0x0030, &ee24c64, false),
           ee_proc_need_in_heating = EEUnit(0x0031, &ee24c64, false),
           ee_proc_waterJacket_filled_yet = EEUnit(0x0032, &ee24c64, false),
           ee_proc_started_hh = EEUnit(0x0033, &ee24c64, false),
           ee_proc_started_mm = EEUnit(0x0034, &ee24c64, false),
           ee_proc_started_DD = EEUnit(0x0035, &ee24c64, false),
           ee_proc_started_MM = EEUnit(0x0036, &ee24c64, false),
           ee_proc_started_YY = EEUnit(0x0037, &ee24c64, false),
           ee_proc_paused_hh = EEUnit(0x0038, &ee24c64, false),
           ee_proc_paused_mm = EEUnit(0x0039, &ee24c64, false),
           ee_proc_paused_DD = EEUnit(0x003A, &ee24c64, false),
           ee_proc_paused_MM = EEUnit(0x003B, &ee24c64, false),
           ee_proc_paused_YY = EEUnit(0x003C, &ee24c64, false),
           ee_proc_exp_finish_hh = EEUnit(0x003D, &ee24c64, false),
           ee_proc_exp_finish_mm = EEUnit(0x003E, &ee24c64, false),
           ee_proc_exp_finish_DD = EEUnit(0x003F, &ee24c64, false),
           ee_proc_exp_finish_MM = EEUnit(0x0040, &ee24c64, false),
           ee_proc_exp_finish_YY = EEUnit(0x0041, &ee24c64, false),
           ee_proc_finished_hh = EEUnit(0x0042, &ee24c64, false),
           ee_proc_finished_mm = EEUnit(0x0043, &ee24c64, false),
           ee_proc_finished_DD = EEUnit(0x0044, &ee24c64, false),
           ee_proc_finished_MM = EEUnit(0x0045, &ee24c64, false),
           ee_proc_finished_YY = EEUnit(0x0046, &ee24c64, false),
           ee_proc_finished_flag = EEUnit(0x0047, &ee24c64, false),
           ee_hard_reset_value_setted = EEUnit(0x0048, &ee24c64, false),

           ee_dynamic_rtc_curr_hh = EEUnit(0x0049, &ee24c64, false, ee24c64.getSectorStartAddr()),
           ee_dynamic_rtc_curr_mm = EEUnit(0x004A, &ee24c64, false, ee24c64.getSectorStartAddr()),
           ee_dynamic_rtc_curr_ss = EEUnit(0x004B, &ee24c64, true, ee24c64.getSectorStartAddr());
